\name{mixcure.penal.profile.nested}
\alias{mixcure.penal.profile.nested}
%- Also NEED an '\alias' for EACH other topic documented here.
\title{
mixcure.penal.profile.nested
}
\description{
...
mc.mle.plci1 <- mixcure.penal.profile.CI(Surv(Time, CENS == 1) ~ Her2,data=ANNbcBMdat1,init=c(1,-0.1,-10,1,1), pl=F)
# Now the bias-reduced fit:
mc.ple.plci1 <- mixcure.penal.profile.CI(Surv(Time, CENS == 1) ~ Her2,data=ANNbcBMdat1,init=c(1,-0.1,-10,1,1), pl=T)
